...
)
{
    ...
    if($jobId > 0)
    {
        header("location:../../view/employer/job_form.php?id=" . $jobId . "&err=missing");
    }
    else
    {
        header("location:../../view/employer/job_form.php?err=missing");
    }
...
if($jobId > 0)
{
    ...
    header("location:../../view/employer/dashboard.php?updated=1");
    exit();
...
if($newId > 0)
{
    header("location:../../view/employer/dashboard.php?created=1");
}
else
{
    header("location:../../view/employer/job_form.php?err=db");
}
